    ...
    return (
        <div className='wrapper clear'>
            <header className='d-flex justify-between align-center p-40'>
                <div className='headerLeft d-flex'>
                    ...
                    <div className='headerInfo'>
                        <h3 className='text-uppercase m-auto'>React Sneakers</h3>
                        <p className='m-auto'>Магазин лучших кроссовок</p>
                    </div>
                </div>
                <div>
                    <ul className='headerRight d-flex justify-between'>
            ...
            <div className='content p-40'>
                ...
                {/*        </form>*/}
                {/*        <svg className='searchIcon pos-a' width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>*/}
                {/*            <path*/}
                ...
                <div className='d-flex justify-between'>
                    <div className='card'>
                        ...
                        {/*            <path d="M6.5 11L6.26951 11.4437L6.5 11.5634L6.73049 11.4437L6.5 11ZM6.5 11C6.73049 11.4437 6.73064 11.4436 6.73081 11.4435L6.73126 11.4433L6.73252 11.4426L6.73654 11.4405L6.75045 11.4332C6.76228 11.4269 6.77919 11.4178 6.80083 11.4061C6.8441 11.3825 6.90635 11.348 6.98485 11.3031C7.1418 11.2132 7.36413 11.081 7.63008 10.9098C8.16097 10.5679 8.87084 10.0669 9.58301 9.431C10.9857 8.17864 12.5 6.31094 12.5 4.03571C12.5 2.10133 10.9857 0.5 9.07812 0.5C8.04427 0.5 7.12431 0.972739 6.5 1.71144C5.87568 0.972739 4.95573 0.5 3.92188 0.5C2.01433 0.5 0.5 2.10133 0.5 4.03571C0.5 6.31094 2.01435 8.17864 3.41699 9.431C4.12916 10.0669 4.83903 10.5679 5.36992 10.9098C5.63587 11.081 5.8582 11.2132 6.01515 11.3031C6.09365 11.348 6.1559 11.3825 6.19917 11.4061C6.22081 11.4178 6.23772 11.4269 6.24955 11.4332L6.26346 11.4405L6.26748 11.4426L6.26874 11.4433L6.26919 11.4435C6.26936 11.4436 6.26951 11.4437 6.5 11Z" fill="#ffffff" stroke="#E3E3E3"/>*/}
                        {/*        </svg>*/}

                        {/*    </button>*/}
                        {/*</div>*/}
                        <img width={133} height={112} src='/img/sneakers/1.jpg' alt='Мужские Кроссовки Nike Blazer Mid Suede'/>
                    ...
                    <div className='card'>
                        ...
                        {/*    </button>*/}
                        {/*</div>*/}
                        <img width={133} height={112} src='/img/sneakers/2.jpg' alt='Мужские Кроссовки Nike Blazer Mid Suede'/>
                        <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
                        <div className='d-flex justify-between align-center'>
                            <div className='d-flex flex-column cardBottom'>
                                <span className='text-uppercase'>Цена:</span>
                    ...
                    <div className='card'>
                        ...
                        {/*    </button>*/}
                        {/*</div>*/}
                        <img width={133} height={112} src='/img/sneakers/3.jpg' alt='Мужские Кроссовки Nike Blazer Mid Suede'/>
                        <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
                        <div className='d-flex justify-between align-center'>
                            <div className='d-flex flex-column cardBottom'>
                                <span className='text-uppercase'>Цена:</span>
                    ...
                    <div className='card'>
                        ...
                        {/*    </button>*/}
                        {/*</div>*/}
                        <img width={133} height={112} src='/img/sneakers/4.jpg' alt='Мужские Кроссовки Nike Blazer Mid Suede'/>
                        <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
                        <div className='d-flex justify-between align-center'>
                            <div className='d-flex flex-column cardBottom'>
                                <span className='text-uppercase'>Цена:</span>
